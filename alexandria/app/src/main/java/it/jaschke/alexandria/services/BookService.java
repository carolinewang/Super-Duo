...
public class BookService extends IntentService {
    ...
    private void fetchBook(String ean) {
        ...
        if(ean.length()!=13){
            setStatus(this, STATUS_SERVER_INVALID);
            return;
        }
        ...
        try {
            ...
            Log.d("book Json",bookJsonString);
        } catch (Exception e) {
            Log.e(LOG_TAG, "Error ", e);
            setStatus(this, STATUS_SERVER_DOWN);
        } finally {
    ...
    int getStatus(Context c){
        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(c);
        return sp.getInt(c.getString(R.string.pref_status_key), STATUS_UNKNOWN);
    }
 }